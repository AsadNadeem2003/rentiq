...
const media_validation_pipe_1 = require("./pipes/media-validation.pipe");
const property_dto_1 = require("./dto/property.dto");
const jwt_auth_guard_1 = require("../auth/guards/jwt-auth.guard");
let PropertiesController = class PropertiesController {
    propertiesService;
    supabaseService;
    constructor(propertiesService, supabaseService) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [property_dto_1.QueryPropertyDto]),
...
__decorate([
    ...
    __param(2, (0, common_1.UploadedFiles)(media_validation_pipe_1.MediaValidationPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [property_dto_1.CreatePropertyDto, Object, Array]),
