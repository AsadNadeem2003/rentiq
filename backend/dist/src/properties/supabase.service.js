...
let SupabaseService = class SupabaseService {
    ...
    constructor(configService) {
        ...
        this.supabase = (0, supabase_js_1.createClient)(supabaseUrl || 'http://placeholder', supabaseKey || 'placeholder', {
            auth: {
    ...
    async uploadFile(file) {
        ...
        const { data: { publicUrl }, } = this.supabase.storage.from('properties').getPublicUrl(fileName);
        return publicUrl;
    }
};
