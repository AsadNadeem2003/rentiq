...
let ConversationsService = class ConversationsService {
    ...
    async createOrGetConversation(propertyId, buyerId) {
        ...
        async;
        findOne(conversationId, string, userId, string);
        {
        ...
        async;
        getMessages(conversationId, string, userId, string, page, number = 1, limit, number = 50);
        {
            const conversation = await this.prisma.conversation.findUnique({
                where: { id: conversationId },
            });
        ...
        async;
        createMessage(conversationId, string, userId, string, text, string);
        {
            const conversation = await this.prisma.conversation.findUnique({
                where: { id: conversationId },
